                ...
                <div class="col-md-12 ">
                    <div class="card baseBlock">
                        ...
                        <div class="card-footer primary-background">
                            ...
                            %>
                            <a href="#!" onclick="doLike(<%= p.getPid()%>,<%= user.getId()%>)" class="btn btn-outline-light btn-sm "><i class="far fa-thumbs-up"></i><span class="like-counter"> <%= ld.countLikeOnPost(p.getPid())%></span></a>
